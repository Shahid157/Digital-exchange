...
function CoinInput(props: Props, ref: any) {
  return (
    <TouchableOpacity
      activeOpacity={1}
    ...
    >
      ...
      >
        ...
        <View style={[styles.container, props.inputStyle]}>
          ...
          >
            <FastImage
              source={GetImageForCoin(props?.coin?.ticker?.toUpperCase())}
              resizeMode={FastImage.resizeMode.contain}
              style={[styles.icon]}
            />

            <AppText style={{ marginStart: THEME.MARGIN.LOW }}>
            ...
            <TextInput
              ...
              style={
                props.isSpecial
                  ...
                  : [styles.inputContainer, props.textInputStyle]
              }
            />
          </View>
          {props.icon ? (
